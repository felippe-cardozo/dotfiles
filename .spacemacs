...
before packages are loaded."
  ...
  (with-eval-after-load 'clojure-mode
    ...
    (with-eval-after-load 'markdown-mode
      (evil-define-key 'normal markdown-mode-map "gj" nil)
      (evil-define-key 'normal markdown-mode-map "gk" nil))
    (setq evil-insert-state-cursor '(box "indian red"))
    ;; dummy
    (defun silence ()
      (interactive))
